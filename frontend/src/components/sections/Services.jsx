  ...
  return (
    <section id="services" className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="font-serif text-3xl md:text-4xl font-semibold text-center text-[#0c1f33] mb-12">
          Our Services
        </h2>
          ...
          {services.map((service) => {
            ...
            return (
              <div key={service.title}>
                ...
                <h3 className="font-sans font-semibold text-lg text-[#0c1f33] text-center mb-2">
                  {service.title}
                </h3>
                <p className="font-sans text-gray-500 text-center leading-relaxed">
                  {service.desc}
                </p>
              </div>
            );
